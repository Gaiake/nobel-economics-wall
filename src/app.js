...
function renderNavigation() {
  return `
    <aside class="nav-panel" aria-label="大屏导航">
      ...
      <p class="nav-intro">
        基地以数字化为核心抓手，打造沉浸式经济学科普阵地，联动业界优质资源构建立体化科普生态，将抽象经济理论转化为可互动、可查阅、可感知的鲜活内容。阵地打破课堂与金融市场的边界，兼具知识性、趣味性与实践性，助力师生零距离触摸市场运行脉搏。未来将持续拓展业界合作版图，丰富科普载体维度，以数字赋能夯实学科育人底色，打造兼具专业深度与传播活力的经济学科普示范窗口。
      </p>
